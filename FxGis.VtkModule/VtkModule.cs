...
namespace FxGis.VtkModule
{
   public class VtkModule : IModule
    {
        public static string RegionName = "SceneRegion";

        public void OnInitialized(IContainerProvider containerProvider)
        {
            var regionManager = containerProvider.Resolve<IRegionManager>();
            regionManager.RegisterViewWithRegion(RegionName, typeof(SceneView));
        }
